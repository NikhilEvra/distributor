...
@Component({
  selector: 'app-p-open-complaints',
  templateUrl: './p-open-complaints.page.html',
  styleUrls: ['./p-open-complaints.page.scss'],
})
export class POpenComplaintsPage implements OnInit {
  response:any=[];
  idd:any=[];
  ...
  complaint(){
  this.api.getOpenComplaints(this.idd.id).subscribe({
      next:(data) =>{
        console.log(data);
        this.response = data;
